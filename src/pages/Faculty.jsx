...
const Faculty = ({ facultyList }) => {
  ...
  //   <FacultyDetail id={event.currentTarget.id} facultyList={facultyList} />;

  // };
  return (
    <>
      {/* Container for demo purpose */}
      <div className="max-w-7xl container my-24 mx-auto md:px-6">
        {/* Section: Design Block */}
        <section className="mb-32 text-center">
          <h2 className="mb-12 text-3xl font-bold">Faculty</h2>
          <div className="lg:gap-xl-12 grid gap-x-6 md:grid-cols-3 xl:grid-cols-4">
            {facultyList.map((faculty) => (
              <RouteLink to={`faculty-detail/${faculty.id}`}>
                <div className="mb-12" key={faculty.id}>
                  <img
                    src={faculty.image}
                    ...
                    style={{ maxWidth: 100 }}
                  />
                  <p className="mb-2 font-bold">{faculty.name}</p>
