    ...
    <nav className="bg-white border-gray-200 light:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <RouteLink to={"/"} className="flex items-center">
          <img
            src={require("../assets/ims_logo.png")}
            className="h-16 mr-3"
            alt="Imsciences Logo"
          />
        </RouteLink>
        <div className="flex md:order-2">
          <button
            ...
            aria-expanded="false"
            className="md:hidden text-gray-500 light:text-gray-400 hover:bg-gray-100 light:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 light:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-1"
          >
            <svg
              className="w-5 h-5"
              aria-hidden="true"
          ...
          <div className="relative hidden md:block">
            ...
            <input
              type="text"
              id="search-navbar"
              className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500"
              placeholder="Search..."
            />
          </div>
          <button
        ...
        >
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white light:bg-gray-800 md:light:bg-gray-900 light:border-gray-700">
            ...
            <li>
              <a
                href="#"
                className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 light:text-white md:light:hover:text-blue-500 light:hover:bg-gray-700 light:hover:text-white md:light:hover:bg-transparent light:border-gray-700"
              >
                Events
              </a>
            </li>
